...
const Gallery = () => {
    return (
        <div className='bg-[#fae8ff] border-8 border-indigo-500/100 rounded-lg mt-6 w-3/4  mx-auto '>
            <h1 className='text-3xl text-center pt-3 '>Disney Gallery</h1>
            <div className='hero-content lg:flex-row-reverse '>
                ...
                <img className="mask mask-hexagon-2 h-36 p-2" src="https://media.very.co.uk/i/very/VDLJM_SQ2_0000000088_NO_COLOR_SLf/disney-princess-aurora-fashion-doll.jpg?$180x240_retinamobilex2$" />
            </div>
            <div className='hero-content lg:flex-row-reverse'>
                ...
                <img className="mask mask-hexagon-2 h-32 p-1" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNlqNfFaOs-PwHK79oOteWGmdYoFOiArD9kw&usqp=CAU" />
            ...
            <div className='hero-content lg:flex-row-reverse'>
                ...
                <img className="mask mask-hexagon-2 h-24" src="https://cdn.shopify.com/s/files/1/0643/8672/8148/products/61CbG4WLtmL._AC_SL1000_1200x1200.jpg?v=1666900561" />
