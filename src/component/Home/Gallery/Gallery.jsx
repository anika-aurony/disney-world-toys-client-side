    ...
    return (
        <div className='mt-8 bg-[#fae8ff] border-8 border-indigo-500/100 rounded-lg mt-6 w-3/4  mx-auto mob-width'>
            ...
            <div className='hero-content lg:flex-row-reverse padding-mob '>
                ...
                <img className="mask mask-hexagon-2 h-24 image-display" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPYtDqqCnWLhYdIR1UgeOM2om_pL_GGuLoow&usqp=CAU" />
            ...
            <div className='hero-content lg:flex-row-reverse'>
                ...
                <img className="mask mask-decagon h-24 image-display" src="https://i5.walmartimages.com/asr/5d133532-cb5b-4817-a1a0-396704839bfb.cb16677ac633beb49ae92c8de4b5be07.jpeg?odnHeight=784&odnWidth=580&odnBg=FFFFFF" />
